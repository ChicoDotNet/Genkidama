...
**PowerShell está en progreso en PR #70 con 4/17 lecciones.** WorkstationAudit ya ejecuta un diagnóstico real, conserva objetos a través del pipeline, convierte almacenamiento en hallazgos estructurados, maneja fallos de recolección explícitamente, exporta JSON y protege reglas con Pester usando fixtures independientes del hardware. El primer slice mantiene el auditor en modo lectura y usa PowerShell 7.6 LTS como objetivo. El siguiente bloque 5–8 introducirá consultas Windows detrás de fronteras explícitas, más reglas reutilizables y configuración. No se abre Ruby mientras PowerShell siga incompleto salvo motivo documentado.
