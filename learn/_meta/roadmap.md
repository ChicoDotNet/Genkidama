...
**PowerShell está en progreso en PR #70 con 8/17 lecciones.** WorkstationAudit ya cubre diagnóstico portable, configuración validada de umbrales, consultas CIM de Windows detrás de una frontera explícita, semántica clara para plataformas no soportadas, reglas reutilizables de almacenamiento/memoria y composición determinista con Pester sobre Windows y Ubuntu. Los dos primeros checkpoints están completos. El siguiente bloque 9–12 añadirá inventario con límites explícitos, seguridad de ejecución/privilegios, reporte humano + JSON y comparación entre ejecuciones sin convertir la auditoría en remediación. No se abre Ruby mientras PowerShell siga incompleto salvo motivo documentado.
