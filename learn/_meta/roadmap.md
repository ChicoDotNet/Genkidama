...
**Ruby está en progreso en PR #71 con 12/17 lecciones.** ContactDesk ya cubre Ruby/Rails ejecutable, validaciones y persistencia, búsqueda y filtros Active Record, edición, asociaciones y notas, errores operativos explícitos, exportación/importación CSV transaccional, límites de entrada y debugging con evidencia. La matriz Ubuntu/Windows detectó y corrigió deuda real de entorno, TZInfo, quoting de shell, `csv` como dependencia explícita en Ruby 4 y uploads multipart de integración. El siguiente bloque es 13–16 + Checkpoint 04; no se abre Dart mientras Ruby siga incompleto salvo motivo documentado.
