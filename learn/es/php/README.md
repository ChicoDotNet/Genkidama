...
AgendaPHP crece sobre una sola base de código. Al completar el curso permite:
...
- demostrar autonomía con una evaluación final de mantenimiento sobre la misma aplicación.

La persistencia JSON sigue siendo deliberadamente local y de una sola instancia. Las consultas son proyecciones pequeñas y baratas sobre el calendario cargado; `AppointmentStore` mantiene la frontera preparada para SQLite cuando consultas selectivas, volumen, transacciones o coordinación de escritores hagan visible el beneficio.
...
### ¿Qué significa aprobar la evaluación final?

Significa que pudiste leer y modificar esta base, proteger comportamiento con pruebas y explicar decisiones sin una receta. La rúbrica mide la evaluación; no garantiza empleo ni sustituye experiencia profesional.
