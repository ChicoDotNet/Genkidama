...
Module PatternSweep
    ...
    Private Function MicroservicesPattern() As Boolean
        Dim stock=7 : Dim reserve As Func(Of Integer,Boolean)=Function(q) If(q>stock,False,(Function() As Boolean : stock-=q : Return True : End Function)())
    ...
    Private Function MonitorObjectPattern() As Boolean
        Dim gate As New Object(),value=0 : SyncLock gate : value+=2 : End SyncLock : SyncLock gate : value+=3 : End SyncLock : Return value=5
    End Function
