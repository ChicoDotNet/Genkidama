...
type
  ...
  public
    constructor Create(Auth: TAuthService; Inventory: TInventoryService; Billing: TBillingService);
...
constructor TCheckoutFacade.Create(Auth: TAuthService; Inventory: TInventoryService; Billing: TBillingService);
begin
  FAuth := Auth;
