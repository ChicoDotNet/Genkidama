include 'src/Systems/Fortran/patterns/command.f90'
include 'src/Systems/Fortran/patterns/interpreter.f90'
include 'src/Systems/Fortran/patterns/iterator.f90'
include 'src/Systems/Fortran/patterns/mediator.f90'
include 'src/Systems/Fortran/patterns/memento.f90'
include 'src/Systems/Fortran/patterns/observer.f90'
include 'src/Systems/Fortran/patterns/state.f90'
include 'src/Systems/Fortran/patterns/strategy.f90'
include 'src/Systems/Fortran/patterns/template_method.f90'
include 'src/Systems/Fortran/patterns/visitor.f90'
include 'src/Systems/Fortran/patterns/mvc.f90'
include 'src/Systems/Fortran/patterns/mvvm.f90'
include 'src/Systems/Fortran/patterns/microkernel.f90'
include 'src/Systems/Fortran/patterns/microservices.f90'
include 'src/Systems/Fortran/patterns/enterprise_adapter.f90'
include 'src/Systems/Fortran/patterns/enterprise_bridge.f90'
include 'src/Systems/Fortran/patterns/enterprise_facade.f90'
include 'src/Systems/Fortran/patterns/broker.f90'
include 'src/Systems/Fortran/patterns/message_bus.f90'
include 'src/Systems/Fortran/patterns/service_locator.f90'
include 'src/Systems/Fortran/patterns/active_object.f90'
include 'src/Systems/Fortran/patterns/monitor_object.f90'
include 'src/Systems/Fortran/patterns/half_sync_half_async.f90'
include 'src/Systems/Fortran/patterns/leader_followers.f90'
include 'src/Systems/Fortran/patterns/client_server.f90'
include 'src/Systems/Fortran/patterns/peer_to_peer.f90'
include 'src/Systems/Fortran/patterns/publish_subscribe.f90'
include 'src/Systems/Fortran/patterns/distributed_proxy.f90'
include 'src/Systems/Fortran/patterns/presentation_abstraction_control.f90'
include 'src/Systems/Fortran/patterns/model_view_presenter.f90'
include 'src/Systems/Fortran/patterns/document_view.f90'
include 'src/Systems/Fortran/patterns/active_record.f90'
include 'src/Systems/Fortran/patterns/data_mapper.f90'
include 'src/Systems/Fortran/patterns/unit_of_work.f90'
include 'src/Systems/Fortran/patterns/repository.f90'
include 'src/Systems/Fortran/patterns/dependency_injection.f90'
include 'src/Systems/Fortran/patterns/lazy_initialization.f90'
include 'src/Systems/Fortran/patterns/object_pool.f90'
include 'src/Systems/Fortran/patterns/null_object.f90'
